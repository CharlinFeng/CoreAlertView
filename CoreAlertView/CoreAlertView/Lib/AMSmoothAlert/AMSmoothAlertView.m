...
- (void) buttonSetupForType:(AlertType)type withCancelButton:(BOOL) hasCancelButton andColor:(UIColor*) color
{
    ...
    if (hasCancelButton) {
        ...
        _cancelButton.backgroundColor = [UIColor colorWithRed:0.7 green:0.7 blue:0.7 alpha:1];
...
-(void) triggerDropAnimations
{
    ...
    [animationBlocks addObject:^(BOOL finished){
        ...
        [UIView animateWithDuration:0.8 delay:0.0 usingSpringWithDamping:0.7 initialSpringVelocity:6 options:UIViewAnimationOptionCurveEaseOut animations:^{
